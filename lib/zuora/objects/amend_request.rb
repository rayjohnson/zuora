module Zuora::Objects
  class AmendRequest < Base
    ...
    validate do |request|
      ...
      self.validation_errors << request.must_be_present(:plans_and_charges) unless amendment.type == "TermsAndConditions" || amendment.type == "Renewal" || amedment.type == "Cancellation"
    end
